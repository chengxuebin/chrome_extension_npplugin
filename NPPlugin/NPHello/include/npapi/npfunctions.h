...
GSMMULTIPORT_API NPError  OSCALL   NP_GetEntryPoints(NPPluginFuncs* pFuncs);



typedef NPError (*NP_InitializeFunc)(NPNetscapeFuncs*);
GSMMULTIPORT_API NPError  OSCALL   NP_Initialize(NPNetscapeFuncs* bFuncs);


typedef NPError (*NP_ShutdownFunc)(void);
GSMMULTIPORT_API NPError  OSCALL  NP_Shutdown(void);


typedef char*   (*NP_GetMIMEDescriptionFunc)(void);
GSMMULTIPORT_API char*     NP_GetMIMEDescription(void);
